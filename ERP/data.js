...
const ALERTS = [
  ...
  { type: "warn", title: "Low stock: PN-2241 (Hydraulic Seals)", sub: "Mumbai DC — 18 units, reorder at 50", time: "14m ago" },
...
const STOCK = [
  { sku: "PN-1023", name: "Industrial Ball Bearing 6205-2RS", wh: "Mumbai DC", qty: 1284, reorder: 500, uom: "pcs", value: 642000, status: "in" },
  { sku: "PN-1188", name: "Hydraulic Cylinder — 50mm Bore", wh: "Pune Plant", qty: 84, reorder: 120, uom: "pcs", value: 1344000, status: "low" },
  { sku: "PN-2241", name: "Hydraulic Seal Kit (Std)", wh: "Mumbai DC", qty: 18, reorder: 50, uom: "kit", value: 43200, status: "crit" },
  { sku: "PN-3310", name: "Stainless Fastener M8×40 Pack", wh: "Chennai Hub", qty: 4820, reorder: 1000, uom: "pack", value: 482000, status: "in" },
  { sku: "PN-4102", name: "Copper Bus Bar 30×10", wh: "Bengaluru WH", qty: 612, reorder: 200, uom: "m", value: 918000, status: "in" },
  { sku: "PN-4480", name: "Servo Motor 400W", wh: "Pune Plant", qty: 0, reorder: 25, uom: "pcs", value: 0, status: "out" },
  { sku: "PN-5021", name: "PLC Module — 16 I/O", wh: "Chennai Hub", qty: 142, reorder: 60, uom: "pcs", value: 2130000, status: "in" },
  { sku: "PN-5519", name: "Control Panel Enclosure 600×800", wh: "Mumbai DC", qty: 42, reorder: 50, uom: "pcs", value: 504000, status: "low" },
  { sku: "PN-6612", name: "VFD Drive — 7.5kW", wh: "Bengaluru WH", qty: 28, reorder: 20, uom: "pcs", value: 1260000, status: "in" },
  { sku: "PN-7080", name: "Industrial Conveyor Belt — 800mm", wh: "Pune Plant", qty: 186, reorder: 80, uom: "m", value: 558000, status: "in" },
  { sku: "PN-7742", name: "SCADA License (annual)", wh: "HQ Vault", qty: 6, reorder: 10, uom: "lic", value: 1800000, status: "low" },
  { sku: "PN-8821", name: "Lubricant Grease — 5kg Drum", wh: "Chennai Hub", qty: 310, reorder: 150, uom: "drum", value: 186000, status: "in" },
];
...
const QUOTE = {
  ...
  lines:[
    { sku:"PN-5021", name:"PLC Module — 16 I/O", qty: 40, rate: 15000, tax: 18 },
    { sku:"PN-6612", name:"VFD Drive — 7.5kW", qty: 8, rate: 45000, tax: 18 },
    { sku:"PN-5519", name:"Control Panel Enclosure 600×800", qty: 12, rate: 12000, tax: 18 },
