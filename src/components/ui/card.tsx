...
/* Comprint ERP card — matches design prototype */
function Card({
  className,
  size = "default",
  ...props
...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "text-[14px] font-semibold leading-snug group-data-[size=sm]/card:text-[13px]",
        className
      )}
      {...props}
    />
...
function CardContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("px-[18px] group-data-[size=sm]/card:px-3", className)}
      {...props}
    />
  )
}
...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex items-center rounded-b-[12px] border-t border-[#E4E7EC] bg-[#FAFBFC] p-[14px_18px] group-data-[size=sm]/card:p-3",
        className
      )}
      {...props}
    />
