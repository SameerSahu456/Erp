    ...
    case 'stock-summary':
      return {
        columns: [
          ...
          { key: 'pullQty', label: 'Pull Qty', align: 'right' },
          { key: 'totalValue', label: 'Total Value (INR)', align: 'right', sortable: true },
        ],
        data: [
          { item: 'Dell Latitude 5540', category: 'Laptops', newQty: 25, refurbQty: 12, pullQty: 8, totalValue: 2850000 },
          { item: 'HP ProBook 450 G10', category: 'Laptops', newQty: 18, refurbQty: 8, pullQty: 5, totalValue: 1860000 },
          { item: 'Dell PowerEdge R750', category: 'Servers', newQty: 4, refurbQty: 2, pullQty: 1, totalValue: 4200000 },
          { item: 'Lenovo ThinkPad T14', category: 'Laptops', newQty: 15, refurbQty: 10, pullQty: 6, totalValue: 1860000 },
          { item: 'HP EliteDesk 800 G9', category: 'Desktops', newQty: 20, refurbQty: 15, pullQty: 10, totalValue: 2250000 },
          { item: 'Dell OptiPlex 7010', category: 'Desktops', newQty: 12, refurbQty: 8, pullQty: 5, totalValue: 1125000 },
          { item: 'Cisco Catalyst 9200', category: 'Networking', newQty: 6, refurbQty: 3, pullQty: 2, totalValue: 1650000 },
        ],
      }
